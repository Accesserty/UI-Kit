var k=Object.defineProperty;var x=(c,t,e)=>t in c?k(c,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):c[t]=e;var v=(c,t,e)=>x(c,typeof t!="symbol"?t+"":t,e);class w extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const t=document.createElement("div");t.setAttribute("class","au-accordion");const e=document.createElement("slot");t.appendChild(e),this.shadowRoot.appendChild(t)}}customElements.define("au-accordion",w);class y extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const t=this.generateId(),e=this.generateId(),a=document.createElement("div");a.setAttribute("class","au-accordion-item"),a.innerHTML=`
    ...
    `,this.tabsList=document.createElement("ul"),this.tabsList.setAttribute("role","tablist"),this.tabsList.classList.add("au-tablist");const e=document.createElement("slot");e.name="panel",this.container.append(t,this.tabsList,e),this.shadowRoot.appendChild(this.container)}connectedCallback(){this._renderTabs(),this._attachEvents()}_renderTabs(){const t=Array.from(this.querySelectorAll(':scope > .au-tab-panel[slot="panel"]'));this._tabs=[],this._panels=[],this.tabsList.innerHTML="",t.forEach((e,a)=>{const i=e.getAttribute("label")||`Tab ${a+1}`,r=e.getAttribute("prefix")||"",o=e.getAttribute("badge")||"",s=e.getAttribute("affix")||"",n=e.id||this.generateId(),u=`tab-${n}`,d=`panel-${n}`;e.setAttribute("id",d),e.setAttribute("role","tabpanel"),e.setAttribute("aria-labelledby",u),e.setAttribute("aria-hidden",a===0?"false":"true");const b=document.createElement("li");b.setAttribute("role","presentation"),b.className="au-tablist-item"+(a===0?" au-tablist-item--selected":"");const h=document.createElement("button");h.setAttribute("role","tab"),h.setAttribute("id",u),h.setAttribute("aria-controls",d),h.setAttribute("aria-selected",a===0?"true":"false"),h.setAttribute("tabindex",a===0?"0":"-1");const p=document.createDocumentFragment();if(r){const l=document.createElement("span");l.className="prefix",l.textContent=r,p.appendChild(l)}const m=document.createElement("span");if(m.className="label",m.textContent=i,p.appendChild(m),o){const l=document.createElement("span");l.className="badge",l.setAttribute("aria-label",`補充資訊：${o}`),l.textContent=o,p.appendChild(l)}if(s){const l=document.createElement("span");l.className="affix",l.textContent=s,p.appendChild(l)}h.appendChild(p),b.appendChild(h),this.tabsList.appendChild(b),this._tabs.push(h),this._panels.push(e)})}_attachEvents(){this._tabs.forEach((t,e)=>{t.addEventListener("click",()=>this._selectTab(e)),t.addEventListener("keydown",a=>this._onKeydown(a,e))})}_selectTab(t){this._tabs.forEach((e,a)=>{const i=a===t;e.setAttribute("aria-selected",i),e.setAttribute("tabindex",i?"0":"-1"),e.parentElement.classList.toggle("au-tablist-item--selected",i),this._panels[a].setAttribute("aria-hidden",!i)}),this._tabs[t].focus(),this._selectedIndex=t}_onKeydown(t,e){const a=this._tabs.length-1;let i=e;switch(t.key){case"ArrowRight":case"ArrowDown":i=e===a?0:e+1;break;case"ArrowLeft":case"ArrowUp":i=e===0?a:e-1;break;case"Home":i=0;break;case"End":i=a;break;default:return}t.preventDefault(),this._selectTab(i)}generateId(){const t=new Uint32Array(1);return window.crypto.getRandomValues(t),t[0].toString(36)}}customElements.define("au-tabs",L);
