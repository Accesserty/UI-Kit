var A=Object.defineProperty;var C=(c,t,e)=>t in c?A(c,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):c[t]=e;var g=(c,t,e)=>C(c,typeof t!="symbol"?t+"":t,e);class L extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const t=document.createElement("div");t.setAttribute("class","au-accordion");const e=document.createElement("slot");t.appendChild(e),this.shadowRoot.appendChild(t)}}customElements.define("au-accordion",L);class S extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const t=this.generateId(),e=this.generateId(),a=document.createElement("div");a.setAttribute("class","au-accordion-item"),a.innerHTML=`
        <style>
          .au-accordion-item {
    ...
    `}}customElements.define("au-breadcrumbs",R);class z extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    ...
    `}}customElements.define("au-card",z);class k extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals();const t=this.generateId(),e=document.createElement("style");e.textContent=`
      .au-checkbox {
        display: inline-block;
        vertical-align: middle;
    ...
    `,this.wrapper=document.createElement("div"),this.wrapper.className="fileupload-wrapper",this.container=document.createElement("div"),this.container.className="fileupload-container",this._id=this.getAttribute("id")||this.generateId(),this.labelEl=document.createElement("label"),this.labelEl.textContent=this.getAttribute("label")||"Upload files",this.labelEl.setAttribute("for",this._id),this.fileInput=document.createElement("input"),this.fileInput.type="file",this.fileInput.hidden=!0,this.fileInput.id=this._id,["accept","multiple","name","disabled","required","form"].forEach(a=>{this.hasAttribute(a)&&this.fileInput.setAttribute(a,this.getAttribute(a))}),this.uploadButton=document.createElement("button"),this.uploadButton.type="button",this.uploadButton.textContent=this.getAttribute("msg-button-text")||"Select files",this.uploadButton.addEventListener("click",()=>this.fileInput.click()),this.dropZone=document.createElement("div"),this.dropZone.className="drop-zone",this.dropZone.textContent=this.getAttribute("msg-drop-text")||"Drop files here",this.fileList=document.createElement("ul"),this.fileList.className="file-list",this.fileList.setAttribute("role","list"),this.fileList.setAttribute("aria-live","assertive"),this.fileList.setAttribute("aria-atomic","true"),this.fileList.setAttribute("role","status"),this.errorMessage=document.createElement("div"),this.errorMessage.className="file-upload-error",this.liveRegion=document.createElement("div"),this.liveRegion.setAttribute("aria-live","polite"),this.liveRegion.setAttribute("role","status"),this.liveRegion.setAttribute("aria-atomic","true"),this.liveRegion.style.position="absolute",this.liveRegion.style.left="-9999px",this.liveRegion.style.height="1px",this.liveRegion.style.overflow="hidden",this.fileInput.addEventListener("change",()=>this.handleFiles(this.fileInput.files)),this.dropZone.addEventListener("dragover",a=>{a.preventDefault(),this.dropZone.classList.add("dragover")}),this.dropZone.addEventListener("dragleave",()=>{this.dropZone.classList.remove("dragover")}),this.dropZone.addEventListener("drop",a=>{a.preventDefault(),this.dropZone.classList.remove("dragover");const i=a.dataTransfer;i!=null&&i.files&&this.handleFiles(i.files)}),this.container.append(this.labelEl,this.uploadButton,this.dropZone,this.fileList,this.errorMessage,this.liveRegion,this.fileInput),this.wrapper.append(this.container),this.shadowRoot.append(e,this.wrapper)}connectedCallback(){document.addEventListener("dragover",this._preventDefault),document.addEventListener("drop",this._preventDefault)}disconnectedCallback(){document.removeEventListener("dragover",this._preventDefault),document.removeEventListener("drop",this._preventDefault)}handleFiles(e){const a=this.getAttribute("msg-type-error")||"is not an accepted file type.",i=this.getAttribute("msg-size-error")||"exceeds the maximum size of",r=this.getAttribute("msg-count-error")||"You can only upload up to",o=parseInt(this.getAttribute("max-files")||"5",10),s=parseFloat(this.getAttribute("max-size-mb")||"5"),n=this.getAttribute("accept"),h=n?n.split(",").map(u=>u.trim()):[],p=Array.from(e),m=[],d=[];p.forEach(u=>{if(!(h.length===0||h.some(f=>f.endsWith("/*")?u.type.startsWith(f.replace("/*","")):u.type===f||u.name.endsWith(f)))){d.push(`${u.name} ${a}`);return}if(u.size>s*1024*1024){d.push(`${u.name} ${i} ${s}MB.`);return}m.push(u)});const b=m.filter(u=>!this.files.some(x=>x.name===u.name&&x.size===u.size)),v=o-this.files.length,l=b.slice(0,v);b.slice(v).forEach(u=>{d.push(`${u.name} ${r} ${o} files.`)}),d.length>0&&this.showErrors(d),l.length!==0&&(this.files.push(...l),this.updateFileList(),this.announce(`${l.length} file${l.length>1?"s":""} added.`),this.syncFormValue(),this.checkValidity(),this.dispatchEvent(new Event("change",{bubbles:!0})),this.fileInput.value="")}showErrors(e){this.errorMessage.innerHTML="";const a=document.createElement("ul");e.forEach(i=>{const r=document.createElement("li");r.textContent=i,a.appendChild(r)}),this.errorMessage.appendChild(a),this.announce(e.join(" "))}announce(e){for(;this.liveRegion.firstChild;)this.liveRegion.removeChild(this.liveRegion.firstChild);requestAnimationFrame(()=>{const a=document.createElement("span");a.textContent=e,this.liveRegion.appendChild(a)})}updateFileList(){this.fileList.innerHTML="",this.files.forEach(e=>{const a=document.createElement("li");a.setAttribute("role","listitem");const i=document.createElement("span");i.textContent=e.name;const r=document.createElement("button");r.textContent=this.getAttribute("msg-remove-text")||"Remove",r.setAttribute("aria-label",`Remove ${e.name}`),r.addEventListener("click",()=>{this.files=this.files.filter(o=>o.name!==e.name||o.size!==e.size),this.updateFileList(),this.announce(`${e.name} removed.`),this.syncFormValue(),this.checkValidity(),this.dispatchEvent(new CustomEvent("remove-file",{detail:e}))}),a.append(i,r),this.fileList.appendChild(a)})}syncFormValue(){const e=new DataTransfer;this.files.forEach(a=>e.items.add(a)),this.internals.setFormValue(e.files)}checkValidity(){return this.hasAttribute("required")&&this.files.length===0?(this.internals.setValidity({valueMissing:!0},this.getAttribute("msg-required")||"Please select at least one file.",this.fileInput),!1):(this.internals.setValidity({}),!0)}get value(){return this.files}set value(e){Array.isArray(e)&&(this.files=e,this.updateFileList(),this.syncFormValue(),this.checkValidity())}generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),`au-file-upload-${e[0].toString(36)}`}formResetCallback(){this.files=[],this.updateFileList(),this.syncFormValue(),this.checkValidity()}focus(){this.uploadButton.focus()}}g(w,"formAssociated",!0);customElements.define("au-file-upload",w);class y extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals(),this._id=this.getAttribute("id")||this.generateId();const t=document.createElement("style");t.textContent=`
    .input-wrapper {
      display: flex;
      align-items: center;
      label {
  ...
  `;const e=document.createElement("div");e.className="input-wrapper",this.wrapper=e,this.labelEl=document.createElement("label"),this.labelEl.setAttribute("for",this._id),this.labelEl.textContent=this.getAttribute("label")||"";const a=document.createElement("div");a.className="input-container",this.prefixSlot=document.createElement("slot"),this.prefixSlot.name="prefix",this.prefixSpan=document.createElement("span"),this.prefixSpan.className="prefix",this.prefixSpan.appendChild(this.prefixSlot),this.prefixSpan.hidden=!0,this.input=document.createElement("input"),this.input.id=this._id,this.syncAttributes(),this.clearButton=document.createElement("button"),this.clearButton.type="button",this.clearButton.className="clear-input",this.clearButton.textContent="✖",this.clearButton.hidden=!0,this.clearButton.addEventListener("click",()=>{this.clear()}),this.affixSlot=document.createElement("slot"),this.affixSlot.name="affix",this.affixSpan=document.createElement("span"),this.affixSpan.className="affix",this.affixSpan.appendChild(this.affixSlot),this.affixSpan.hidden=!0,a.append(this.prefixSpan,this.input,this.clearButton,this.affixSpan),e.append(this.labelEl,a),this.shadowRoot.append(t,e),this.input.addEventListener("input",()=>{this.value=this.input.value,this.dispatchEvent(new Event("input",{bubbles:!0})),this.internals.setFormValue(this.value),this._syncValidity(),this._updateClearButton()}),this.input.addEventListener("change",()=>{this.dispatchEvent(new Event("change",{bubbles:!0}))}),this.prefixSlot.addEventListener("slotchange",()=>{this.prefixSpan.hidden=this.prefixSlot.assignedNodes().length===0}),this.affixSlot.addEventListener("slotchange",()=>{this.affixSpan.hidden=this.affixSlot.assignedNodes().length===0})}static get observedAttributes(){return["type","name","value","placeholder","required","disabled","readonly","label","min","max","step","pattern","autocomplete","autofocus","inputmode","maxlength","minlength","data-size","data-layout","data-clear","data-clear-label"]}attributeChangedCallback(t,e,a){t==="label"&&this.labelEl?this.labelEl.textContent=a:(t==="data-size"||t==="data-layout")&&this.wrapper?a===null?this.wrapper.removeAttribute(t):this.wrapper.setAttribute(t,a):t==="data-clear"||t==="data-clear-label"?this._updateClearButton():this.input&&(a===null&&typeof this.input[t]=="boolean"?(this.input[t]=!1,this.input.removeAttribute(t)):(this.input.setAttribute(t,a),typeof this.input[t]=="boolean"&&(this.input[t]=!0)),this._syncValidity())}connectedCallback(){this._initialValueSet||(this._initialValue=this.input.value,this._initialValueSet=!0),this.internals.setFormValue(this.input.value),this._syncValidity(),this._updateClearButton()}formResetCallback(){this.input.value=this._initialValue||"",this.internals.setFormValue(this.input.value),this._syncValidity(),this._updateClearButton()}get value(){var t;return(t=this.input)==null?void 0:t.value}set value(t){this.input&&(this.input.value=t,this.setAttribute("value",t),this.internals.setFormValue(t),this._syncValidity(),this._updateClearButton())}clear(){this.input.value="",this.value="",this.internals.setFormValue(""),this.dispatchEvent(new Event("input",{bubbles:!0})),this.dispatchEvent(new Event("change",{bubbles:!0})),this._updateClearButton()}suggest(t=""){this.input.value=t,this.value=t,this.internals.setFormValue(t),this.dispatchEvent(new Event("input",{bubbles:!0})),this._updateClearButton()}focus(){var t;(t=this.input)==null||t.focus()}generateId(){const t=new Uint32Array(1);return window.crypto.getRandomValues(t),`au-input-${t[0].toString(36)}`}syncAttributes(){Array.from(this.attributes).forEach(t=>{["data-size","data-layout","data-clear","data-clear-label"].includes(t.name)||(this.input.setAttribute(t.name,t.value),t.name==="value"&&(this.input.defaultValue=t.value))})}_syncValidity(){this.input&&(this.input.validity.valid?this.internals.setValidity({}):this.internals.setValidity(this.input.validity,this.input.validationMessage,this.input))}_updateClearButton(){const t=this.hasAttribute("data-clear"),e=this.input.value.length>0,a=this.getAttribute("data-clear-label")||"Clear input";this.clearButton.setAttribute("aria-label",a),this.clearButton.hidden=!(t&&e)}}g(y,"formAssociated",!0);customElements.define("au-input",y);class _ extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const t=document.createElement("style");t.textContent=`
    ...
    `,this.tabsList=document.createElement("ul"),this.tabsList.setAttribute("role","tablist"),this.tabsList.classList.add("au-tablist");const e=document.createElement("slot");e.name="panel",this.container.append(t,this.tabsList,e),this.shadowRoot.appendChild(this.container)}connectedCallback(){this._renderTabs(),this._attachEvents()}_renderTabs(){const t=Array.from(this.querySelectorAll(':scope > .au-tab-panel[slot="panel"]'));this._tabs=[],this._panels=[],this.tabsList.innerHTML="",t.forEach((e,a)=>{const i=e.getAttribute("label")||`Tab ${a+1}`,r=e.getAttribute("data-prefix")||"",o=e.getAttribute("data-badge")||"",s=e.getAttribute("data-affix")||"",n=e.id||this.generateId(),h=`tab-${n}`,p=`panel-${n}`;e.setAttribute("id",p),e.setAttribute("role","tabpanel"),e.setAttribute("aria-labelledby",h),e.setAttribute("aria-hidden",a===0?"false":"true");const m=document.createElement("li");m.setAttribute("role","presentation"),m.className="au-tablist-item"+(a===0?" au-tablist-item--selected":"");const d=document.createElement("button");d.setAttribute("role","tab"),d.setAttribute("id",h),d.setAttribute("aria-controls",p),d.setAttribute("aria-selected",a===0?"true":"false"),d.setAttribute("tabindex",a===0?"0":"-1");const b=document.createDocumentFragment();if(r){const l=document.createElement("span");l.className="prefix",l.textContent=r,b.appendChild(l)}const v=document.createElement("span");if(v.className="label",v.textContent=i,b.appendChild(v),o){const l=document.createElement("span");l.className="badge",l.setAttribute("aria-label",`補充資訊：${o}`),l.textContent=o,b.appendChild(l)}if(s){const l=document.createElement("span");l.className="affix",l.textContent=s,b.appendChild(l)}d.appendChild(b),m.appendChild(d),this.tabsList.appendChild(m),this._tabs.push(d),this._panels.push(e)})}_attachEvents(){this._tabs.forEach((t,e)=>{t.addEventListener("click",()=>this._selectTab(e)),t.addEventListener("keydown",a=>this._onKeydown(a,e))})}_selectTab(t){this._tabs.forEach((e,a)=>{const i=a===t;e.setAttribute("aria-selected",i),e.setAttribute("tabindex",i?"0":"-1"),e.parentElement.classList.toggle("au-tablist-item--selected",i),this._panels[a].setAttribute("aria-hidden",!i)}),this._tabs[t].focus(),this._selectedIndex=t}_onKeydown(t,e){const a=this._tabs.length-1;let i=e;switch(t.key){case"ArrowRight":case"ArrowDown":i=e===a?0:e+1;break;case"ArrowLeft":case"ArrowUp":i=e===0?a:e-1;break;case"Home":i=0;break;case"End":i=a;break;default:return}t.preventDefault(),this._selectTab(i)}generateId(){const t=new Uint32Array(1);return window.crypto.getRandomValues(t),t[0].toString(36)}}customElements.define("au-tabs",V);class E extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals(),this._id=this.getAttribute("id")||this.generateId();const t=document.createElement("style");t.textContent=`
      .textarea-wrapper {
        display: flex;
        flex-direction: column;
        gap: 0.25rem;
