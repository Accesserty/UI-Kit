var z=Object.defineProperty;var I=(g,e,t)=>e in g?z(g,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):g[e]=t;var x=(g,e,t)=>I(g,typeof e!="symbol"?e+"":e,t);class N extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._container=document.createElement("div"),this._container.setAttribute("class","au-accordion");const e=document.createElement("slot");this._container.appendChild(e),this._exclusiveHint=document.createElement("span"),this._exclusiveHint.style.cssText="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0;padding:0;";const t=`au-accordion-hint-${Math.random().toString(36).slice(2)}`;this._exclusiveHint.id=t,this._exclusiveHint.textContent="Only one section may be expanded at a time.",this.shadowRoot.appendChild(this._exclusiveHint),this.shadowRoot.appendChild(this._container),this._onToggle=this._handleToggle.bind(this)}connectedCallback(){this.addEventListener("au-toggle",this._onToggle),this._updateExclusiveAria()}disconnectedCallback(){this.removeEventListener("au-toggle",this._onToggle)}static get observedAttributes(){return["exclusive"]}get exclusive(){return this.hasAttribute("exclusive")}set exclusive(e){e?this.setAttribute("exclusive",""):this.removeAttribute("exclusive")}attributeChangedCallback(e,t,a){e==="exclusive"&&t!==a&&this._updateExclusiveAria()}_updateExclusiveAria(){this.exclusive?this._container.setAttribute("aria-describedby",this._exclusiveHint.id):this._container.removeAttribute("aria-describedby")}_handleToggle(e){if(!this.exclusive||!e.detail.open)return;[...this.children].filter(a=>a.tagName.toLowerCase()==="au-accordion-item"&&a!==e.target).forEach(a=>{a.open=!1})}}typeof customElements<"u"&&!customElements.get("au-accordion")&&customElements.define("au-accordion",N);class T extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const e=this.generateId(),t=this.generateId(),a=document.createElement("div");a.setAttribute("class","au-accordion-item"),a.innerHTML=`
        <style>
          .au-accordion-item {
      ...
      >
        <ol>
          ${s.map((c,h)=>`
                <li>
                  ${h===s.length-1?`<span aria-current="page"><slot name="icon-${h+1}"></slot><span>${c.text}</span></span>`:`<a href="${c.url||""}" title="${n} ${c.text}"><slot name="icon-${h+1}"></slot><span>${c.text}</span></a>`}
                  ${h!==s.length-1?'<span aria-hidden="true">'+o+"</span>":""}
                </li>
              `).join("")}
        </ol>
      </nav>
    `}}typeof customElements<"u"&&!customElements.get("au-breadcrumbs")&&customElements.define("au-breadcrumbs",$);class V extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    ...
    `}}typeof customElements<"u"&&!customElements.get("au-card")&&customElements.define("au-card",V);class A extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals();const e=this.generateId(),t=document.createElement("style");t.textContent=`
      .au-checkbox {
        display: inline-block;
    ...
    `,this.shadowRoot.appendChild(e.content.cloneNode(!0)),this.item=this.shadowRoot.querySelector(".item")}connectedCallback(){this.setAttribute("tabindex","-1"),this.setAttribute("role","none"),this.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("selected",{bubbles:!0,composed:!0,detail:{value:this.getAttribute("value")}}));const e=this.closest("au-dropdown");e&&e.close()}),this.item.addEventListener("keydown",e=>{if(e.key==="Enter"||e.key===" "||e.key==="Spacebar"){e.preventDefault();const t=this.querySelector("a");t?t.click():this.click()}})}focus(){this.item.focus()}}typeof customElements<"u"&&(customElements.get("au-dropdown")||customElements.define("au-dropdown",M),customElements.get("au-dropdown-item")||customElements.define("au-dropdown-item",D));class C extends HTMLElement{constructor(){super();x(this,"_preventDefault",t=>t.preventDefault());this.attachShadow({mode:"open"}),this.internals=this.attachInternals(),this.files=[],this.previewUrls=new Map;const t=document.createElement("style");t.textContent=`
  ...
  `;const t=document.createElement("div");t.className="input-wrapper",this.wrapper=t,this.labelEl=document.createElement("label"),this.labelEl.setAttribute("for",this._id),this.labelEl.textContent=this.getAttribute("label")||"";const a=document.createElement("div");a.className="input-container",this.inputContainer=a,this.prefixSlot=document.createElement("slot"),this.prefixSlot.name="prefix",this.prefixSpan=document.createElement("span"),this.prefixSpan.className="prefix",this.prefixSpan.appendChild(this.prefixSlot),this.prefixSpan.hidden=!0,this.input=document.createElement("input"),this.input.id=this._id,this.syncAttributes(),this.colorCodeSpan=document.createElement("span"),this.colorCodeSpan.className="color-code",this.colorCodeSpan.hidden=!0,this.clearButton=document.createElement("button"),this.clearButton.type="button",this.clearButton.className="clear-input",this.clearButton.textContent="✖",this.clearButton.hidden=!0,this.clearButton.setAttribute("part","clear"),this.clearButton.addEventListener("click",()=>{this.clear()}),this.affixSlot=document.createElement("slot"),this.affixSlot.name="affix",this.affixSpan=document.createElement("span"),this.affixSpan.className="affix",this.affixSpan.appendChild(this.affixSlot),this.affixSpan.hidden=!0,a.append(this.prefixSpan,this.input,this.colorCodeSpan,this.clearButton,this.affixSpan),t.append(this.labelEl,a),this.shadowRoot.append(e,t),this._bindInputEvents(),this.prefixSlot.addEventListener("slotchange",()=>{this.prefixSpan.hidden=this.prefixSlot.assignedNodes().length===0}),this.affixSlot.addEventListener("slotchange",()=>{this.affixSpan.hidden=this.affixSlot.assignedNodes().length===0})}_bindInputEvents(){this.input.addEventListener("input",()=>{this.value=this.input.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.internals.setFormValue(this.value),this._syncValidity(),this._updateClearButton(),this._updateColorCode()}),this.input.addEventListener("change",()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}static get observedAttributes(){return["type","name","value","placeholder","required","disabled","readonly","label","min","max","step","pattern","autocomplete","autofocus","inputmode","maxlength","minlength","list","data-size","data-layout","data-clear","data-clear-label"]}attributeChangedCallback(e,t,a){if(e==="label"&&this.labelEl)this.labelEl.textContent=a;else if((e==="data-size"||e==="data-layout")&&this.wrapper)a===null?this.wrapper.removeAttribute(e):this.wrapper.setAttribute(e,a);else if(e==="data-clear"||e==="data-clear-label")this._updateClearButton();else if(e==="list")this._handleListAttribute(a);else if(this.input){if(a===null){this.input.removeAttribute(e);const i=e.replace(/-([a-z])/g,(r,s)=>s.toUpperCase());typeof this.input[i]=="boolean"?this.input[i]=!1:typeof this.input[e]=="boolean"&&(this.input[e]=!1)}else{this.input.setAttribute(e,a);const i=e.replace(/-([a-z])/g,(r,s)=>s.toUpperCase());typeof this.input[i]=="boolean"?this.input[i]=!0:typeof this.input[e]=="boolean"&&(this.input[e]=!0)}this._syncValidity(),this._updateColorCode()}}get validity(){return this.internals.validity}get validationMessage(){return this.internals.validationMessage}get willValidate(){return this.internals.willValidate}checkValidity(){return this.internals.checkValidity()}reportValidity(){return this.internals.reportValidity()}connectedCallback(){this._initialValueSet||(this._initialValue=this.input.value,this._initialValueSet=!0),this.internals.setFormValue(this.input.value),this._syncValidity(),this._updateClearButton(),this._updateColorCode(),this.hasAttribute("list")&&requestAnimationFrame(()=>{this._handleListAttribute(this.getAttribute("list"))})}formResetCallback(){const e=this._initialValue||"",t=this.input.cloneNode(!1);t.value=e,this.inputContainer.replaceChild(t,this.input),this.input=t,this._bindInputEvents(),this.internals.setFormValue(e),this._syncValidity(),this._updateClearButton(),this._updateColorCode()}get value(){var e;return(e=this.input)==null?void 0:e.value}set value(e){this.input&&(this.input.value=e,this.setAttribute("value",e),this.internals.setFormValue(e),this._syncValidity(),this._updateClearButton(),this._updateColorCode())}clear(){this.input.value="",this.value="",this.internals.setFormValue(""),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this._updateClearButton(),this._updateColorCode()}suggest(e=""){this.input.value=e,this.value=e,this.internals.setFormValue(e),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this._updateClearButton(),this._updateColorCode()}get disabled(){return this.hasAttribute("disabled")}set disabled(e){e?this.setAttribute("disabled",""):this.removeAttribute("disabled")}get required(){return this.hasAttribute("required")}set required(e){e?this.setAttribute("required",""):this.removeAttribute("required")}get readonly(){return this.hasAttribute("readonly")}set readonly(e){e?this.setAttribute("readonly",""):this.removeAttribute("readonly")}focus(){var e;(e=this.input)==null||e.focus()}generateId(){if(typeof crypto<"u"&&crypto.getRandomValues){const e=new Uint32Array(1);return crypto.getRandomValues(e),`au-input-${e[0].toString(36)}`}return`au-input-${Math.random().toString(36).slice(2)}`}syncAttributes(){Array.from(this.attributes).forEach(e=>{["data-size","data-layout","data-clear","data-clear-label"].includes(e.name)||(this.input.setAttribute(e.name,e.value),e.name==="value"&&(this.input.defaultValue=e.value))})}_syncValidity(){this.input&&(this.input.validity.valid?this.internals.setValidity({}):this.internals.setValidity(this.input.validity,this.input.validationMessage,this.input))}_updateClearButton(){const e=this.hasAttribute("data-clear"),t=this.input.value.length>0,a=this.getAttribute("data-clear-label")||"Clear input";this.clearButton.setAttribute("aria-label",a),this.clearButton.hidden=!(e&&t)}_updateColorCode(){this.input.type==="color"?(this.colorCodeSpan.textContent=this.input.value,this.colorCodeSpan.hidden=!1):this.colorCodeSpan.hidden=!0}_handleListAttribute(e){if(!this.shadowRoot||!this.input)return;const t=this.shadowRoot.querySelector("datalist");if(t&&t.remove(),!e){this.input.removeAttribute("list");return}const a=this.getRootNode(),i=a instanceof Document||a instanceof ShadowRoot?a.getElementById(e):document.getElementById(e);if(i&&i.tagName==="DATALIST"){const r=document.createElement("datalist");r.id=e,Array.from(i.options).forEach(s=>{r.appendChild(s.cloneNode(!0))}),this.shadowRoot.appendChild(r),this.input.setAttribute("list",e)}else this.input.setAttribute("list",e)}}x(_,"formAssociated",!0);typeof customElements<"u"&&!customElements.get("au-input")&&customElements.define("au-input",_);class E extends HTMLElement{static get observedAttributes(){return["data-total","data-current-page","data-pager-count","data-page-size","data-page-size-options","data-layout","data-text-total-pages-prefix","data-text-page","data-text-total-items-suffix","data-text-per","data-text-first","data-text-prev","data-text-next","data-text-last","data-text-go","data-text-goto"]}static generateId(){if(typeof crypto<"u"&&crypto.getRandomValues){const e=new Uint32Array(1);return crypto.getRandomValues(e),`au-pagination-${e[0].toString(36)}`}return`au-pagination-${Math.random().toString(36).slice(2)}`}constructor(){super(),this.attachShadow({mode:"open"}),this._selectId=E.generateId(),this._jumpId=E.generateId(),this.liveRegion=document.createElement("div"),this.liveRegion.setAttribute("aria-live","polite"),this.liveRegion.setAttribute("role","status"),this.liveRegion.setAttribute("aria-atomic","true"),this._parseAttributes(),this._render()}attributeChangedCallback(){this._parseAttributes(),this._requestRender()}_requestRender(){this._updatePending||(this._updatePending=!0,requestAnimationFrame(()=>{this._render(),this._updatePending=!1}))}_parseAttributes(){this.total=parseInt(this.getAttribute("data-total"))||0,this.currentPage=parseInt(this.getAttribute("data-current-page"))||1,this.pagerCount=parseInt(this.getAttribute("data-pager-count"))||5,this.pageSize=parseInt(this.getAttribute("data-page-size"))||10;const e=this.getAttribute("data-page-size-options");if(e)try{this._pageSizeOptions=JSON.parse(e)}catch{this._pageSizeOptions=e.split(",").map(a=>parseInt(a.trim()))}else this._pageSizeOptions=[10,30,50,100];const t=this.getAttribute("data-layout");if(t)try{this._layout=JSON.parse(t)}catch{this._layout=t.replace(/[[\]' ]/g,"").split(",")}else this._layout=["total_page","total_items","page_size","first","prev","pages","next","last","jump"];this.texts={totalPagesPrefix:this.getAttribute("data-text-total-pages-prefix")||"Total",pageSuffix:this.getAttribute("data-text-page")||"page(s)",totalItemsSuffix:this.getAttribute("data-text-total-items-suffix")||"item(s)",perText:this.getAttribute("data-text-per")||"each page",firstText:this.getAttribute("data-text-first")||"First",prevText:this.getAttribute("data-text-prev")||"Prev",nextText:this.getAttribute("data-text-next")||"Next",lastText:this.getAttribute("data-text-last")||"Last",goText:this.getAttribute("data-text-go")||"go to",gotoText:this.getAttribute("data-text-goto")||"go to"}}get pageSizeOptions(){return this._pageSizeOptions??[10,30,50,100]}set pageSizeOptions(e){this._pageSizeOptions=e,this.setAttribute("data-page-size-options",JSON.stringify(e))}get layout(){return this._layout??["total_page","total_items","page_size","first","prev","pages","next","last","jump"]}set layout(e){this._layout=e,this.setAttribute("data-layout",JSON.stringify(e))}get totalPages(){return Math.ceil(this.total/this.pageSize)||1}get pagers(){const t=Math.floor((this.currentPage-1)/this.pagerCount)*this.pagerCount+1,a=Math.min(t+this.pagerCount-1,this.totalPages),i=[];for(let r=t;r<=a;r++)i.push(r);return i}_render(){const e=this.texts,t=this.layout,a=this.totalPages,i=this.total;this.shadowRoot.innerHTML="";const r=document.createElement("style");r.textContent=`
    ...
    `,this.shadowRoot.appendChild(r);const s=document.createElement("div");s.className="au-pagination";const o=document.createElement("div");o.className="au-pagination-container";const n=document.createElement("div");if(n.className="au-pagination-group",t.includes("total_page")){const l=document.createElement("span");l.textContent=`${e.totalPagesPrefix}${a}${e.pageSuffix}`,n.appendChild(l)}if(t.includes("total_items")){const l=document.createElement("span");l.textContent=`${i}${e.totalItemsSuffix}`,n.appendChild(l)}if(t.includes("page_size")){const l=document.createElement("span");l.className="visually-hidden",l.textContent="Page size",n.appendChild(l);const d=document.createElement("label");d.setAttribute("for",this._selectId),d.textContent=e.perText,n.appendChild(d);const u=document.createElement("select");u.id=this._selectId,this.pageSizeOptions.forEach(p=>{const f=document.createElement("option");f.value=p,f.textContent=p,p===this.pageSize&&(f.selected=!0),u.appendChild(f)}),u.addEventListener("change",p=>{this.pageSize=+p.target.value,this.setAttribute("data-page-size",this.pageSize),this.dispatchEvent(new CustomEvent("page-size-change",{detail:this.pageSize,bubbles:!0,composed:!0})),this.currentPage=1,this.setAttribute("data-current-page","1")}),n.appendChild(u);const v=document.createElement("span");v.textContent=e.totalItemsSuffix,n.appendChild(v)}o.appendChild(n);const b=document.createElement("div");b.className="au-pagination-group";const c=document.createElement("ul");if(c.className="pagination-buttons",t.includes("first")){const l=document.createElement("li"),d=document.createElement("button");d.textContent=e.firstText,d.disabled=this.currentPage===1,d.addEventListener("click",()=>this._goto(1)),l.appendChild(d),c.appendChild(l)}if(t.includes("prev")){const l=document.createElement("li"),d=document.createElement("button");d.textContent=e.prevText,d.disabled=this.currentPage===1,d.addEventListener("click",()=>this._goto(this.currentPage-1)),l.appendChild(d),c.appendChild(l)}if(t.includes("pages")&&this.pagers.forEach(l=>{const d=document.createElement("li"),u=document.createElement("button");u.className="pager",l===this.currentPage?(u.setAttribute("aria-current","page"),u.setAttribute("part","current-page")):(u.removeAttribute("aria-current"),u.removeAttribute("part")),u.textContent=l,u.addEventListener("click",()=>this._goto(l)),d.appendChild(u),c.appendChild(d)}),t.includes("next")){const l=document.createElement("li"),d=document.createElement("button");d.textContent=e.nextText,d.disabled=this.currentPage>=a,d.addEventListener("click",()=>this._goto(this.currentPage+1)),l.appendChild(d),c.appendChild(l)}if(t.includes("last")){const l=document.createElement("li"),d=document.createElement("button");d.textContent=e.lastText,d.disabled=this.currentPage>=a,d.addEventListener("click",()=>this._goto(a)),l.appendChild(d),c.appendChild(l)}const h=document.createElement("nav");if(h.setAttribute("aria-label","pagination"),h.appendChild(c),b.appendChild(h),o.appendChild(b),t.includes("jump")){const l=document.createElement("div");l.className="au-pagination-group";const d=document.createElement("label");d.setAttribute("for",this._jumpId),d.textContent=e.goText,l.appendChild(d);const u=document.createElement("input");u.type="number",u.id=this._jumpId,u.min="1",u.max=String(a),u.value=String(this.currentPage),u.addEventListener("keyup",f=>{f.key==="Enter"&&this._goto(+u.value)}),l.appendChild(u);const v=document.createElement("span");v.textContent=e.pageSuffix,l.appendChild(v);const p=document.createElement("button");p.type="button",p.textContent=e.gotoText,p.addEventListener("click",()=>this._goto(+u.value)),l.appendChild(p),o.appendChild(l)}s.appendChild(o),this.shadowRoot.append(s,this.liveRegion)}_goto(e){e<1&&(e=1),e>this.totalPages&&(e=this.totalPages),e!==this.currentPage&&(this.currentPage=e,this.setAttribute("data-current-page",String(e)),this.dispatchEvent(new CustomEvent("page-change",{detail:e,bubbles:!0,composed:!0})),this.announce(`Page ${e}`))}announce(e){for(;this.liveRegion.firstChild;)this.liveRegion.removeChild(this.liveRegion.firstChild);requestAnimationFrame(()=>{const t=document.createElement("span");t.textContent=e,this.liveRegion.appendChild(t)})}}typeof customElements<"u"&&!customElements.get("au-pagination")&&customElements.define("au-pagination",E);class S extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals();const e=document.createElement("style");e.textContent=`
      .au-radio-group {
        display: flex;
        flex-wrap: wrap;
        gap: 1rem;
    ...
    `;const t=document.createElement("div");t.setAttribute("class","au-radio-group"),t.setAttribute("role","radiogroup"),this.groupName="radio-group-name-"+this.generateId();const a=document.createElement("slot");a.style.display="none",this.shadowRoot.append(e,t,a)}connectedCallback(){this.shadowRoot.querySelector("slot").addEventListener("slotchange",()=>{this.renderRadios()}),this.renderRadios();const t=this.getAttribute("aria-label");t&&this.shadowRoot.querySelector(".au-radio-group").setAttribute("aria-label",t),this.getAttribute("direction")==="vertical"&&this.shadowRoot.querySelector(".au-radio-group").classList.add("au-radio-group--vertical")}renderRadios(){const e=this.shadowRoot.querySelector(".au-radio-group");e.innerHTML="";const a=this.shadowRoot.querySelector("slot").assignedElements(),i=this.hasAttribute("disabled");let r=null;a.forEach((s,o)=>{const n=document.createElement("label"),b="radio-"+this.generateId();n.setAttribute("for",b);const c=document.createElement("input");c.type="radio",c.id=b,c.name=this.groupName,c.value=s.getAttribute("value")||`radio-${o+1}`,s.hasAttribute("checked")&&(c.checked=!0,r=c.value),(i||s.hasAttribute("disabled"))&&(c.disabled=!0);const h=document.createElement("div");h.setAttribute("class","text"),h.textContent=s.textContent.trim(),n.append(c,h),e.appendChild(n),c.addEventListener("change",l=>this.handleChange(l,c)),c.addEventListener("keydown",l=>this.handleKeyDown(l,o))}),this.internals.setFormValue(r)}handleChange(e,t){t.checked&&(this.shadowRoot.querySelectorAll(`input[name="${this.groupName}"]`).forEach(i=>{i!==t&&(i.checked=!1)}),this.internals.setFormValue(t.value),this.dispatchEvent(new CustomEvent("change",{bubbles:!0,composed:!0,detail:{value:t.value}})))}handleKeyDown(e,t){const a=Array.from(this.shadowRoot.querySelectorAll(`input[name="${this.groupName}"]`));let i;switch(e.key){case"ArrowRight":case"ArrowDown":for(e.preventDefault(),i=(t+1)%a.length;a[i].disabled;)i=(i+1)%a.length;a[i].focus(),a[i].click();break;case"ArrowLeft":case"ArrowUp":for(e.preventDefault(),i=(t-1+a.length)%a.length;a[i].disabled;)i=(i-1+a.length)%a.length;a[i].focus(),a[i].click();break}}static get observedAttributes(){return["disabled"]}attributeChangedCallback(e){if(e==="disabled"){const t=this.hasAttribute("disabled");this.shadowRoot.querySelectorAll('input[type="radio"]').forEach(a=>{a.disabled=t})}}get value(){const e=Array.from(this.shadowRoot.querySelectorAll('input[type="radio"]')).find(t=>t.checked);return(e==null?void 0:e.value)??null}get disabled(){return this.hasAttribute("disabled")}set disabled(e){e?this.setAttribute("disabled",""):this.removeAttribute("disabled")}formResetCallback(){this.renderRadios()}generateId(){if(typeof crypto<"u"&&crypto.getRandomValues){const e=new Uint32Array(1);return crypto.getRandomValues(e),`${e[0].toString(36)}`}return Math.random().toString(36).slice(2)}}x(S,"formAssociated",!0);typeof customElements<"u"&&!customElements.get("au-radio-group")&&customElements.define("au-radio-group",S);class q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._groupName="rating-"+this.generateId(),this._skipRender=!1;const e=document.createElement("template");e.innerHTML=`
      <style>
        :host {
          display: inline-flex;
          align-items: center;
    ...
    </svg>`}render(){const e=this.getAttribute("aria-label")||"Rating";this._legend.textContent=e,this._fieldset.setAttribute("aria-label",e),this._fieldset.innerHTML='<legend class="visually-hidden"></legend>',this._legend=this._fieldset.querySelector("legend"),this._legend.textContent=e,this.readonly&&this._fieldset.setAttribute("aria-readonly","true"),this.disabled&&this._fieldset.setAttribute("aria-disabled","true");const t=this.labels,a=this.value,i=Math.round(a);for(let r=1;r<=this.max;r++){const s=document.createElement("div");s.className="rating-option";const o=`${this._groupName}-${r}`,n=document.createElement("input");n.type="radio",n.name=this._groupName,n.value=r,n.id=o,r===i&&(n.checked=!0),t[r-1]||n.setAttribute("aria-label",`${r} Star${r!==1?"s":""}`),(this.disabled||this.readonly)&&(n.disabled=!0);const c=document.createElement("label");c.setAttribute("for",o);const h=document.createElement("span");h.className="star-wrapper";const l=Math.floor(a),d=a-l;let u=100;r<=l?u=0:r===l+1&&d>0&&(u=100-d*100),h.style.setProperty("--au-rating-clip",`${u}%`),h.innerHTML=`
        ${this.getStarSVG("star-bg")}
        ${this.getStarSVG("star-fill")}
      `,c.appendChild(h);const v=document.createElement("span");v.className="label-text",v.textContent=t[r-1]||"",c.appendChild(v),s.appendChild(n),s.appendChild(c),this._fieldset.appendChild(s)}this.updateScoreDisplay(a),this._internals.setFormValue(a.toString())}updateScoreDisplay(e){this.showScore?this._scoreEl.textContent=`${e} / ${this.max} ${this.scoreInfo}`.trim():this._scoreEl.textContent=""}handleChange(e){if(e.target.type==="radio"){const t=parseInt(e.target.value);this.value=t,this.updateStars(t),this.updateScoreDisplay(t),this.dispatchEvent(new CustomEvent("change",{bubbles:!0,composed:!0,detail:{value:t}}))}}updateStars(e){const t=this._fieldset.querySelectorAll(".star-wrapper"),a=Math.floor(e),i=e-a;t.forEach((r,s)=>{const o=s+1;r.classList.remove("animate");let n=100;o<=a?(n=0,o===a&&i===0&&r.classList.add("animate")):o===a+1&&i>0&&(n=100-i*100,r.classList.add("animate")),r.style.setProperty("--au-rating-clip",`${n}%`)})}handleKeyDown(e){const t=Array.from(this._fieldset.querySelectorAll('input[type="radio"]')),a=t.findIndex(r=>r===this.shadowRoot.activeElement||r.checked);let i;switch(e.key){case"ArrowRight":case"ArrowDown":e.preventDefault(),this.value===0&&a===0?i=0:i=(a+1)%t.length,t[i].focus(),t[i].click();break;case"ArrowLeft":case"ArrowUp":e.preventDefault(),i=(a-1+t.length)%t.length,t[i].focus(),t[i].click();break}}formResetCallback(){this.value=this.getAttribute("value")||0,this._internals.setFormValue(this.value?this.value.toString():null)}formStateRestoreCallback(e,t){e&&(this.value=e)}}typeof customElements<"u"&&!customElements.get("au-rating")&&customElements.define("au-rating",q);class R extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals();const e=this.generateId(),t=document.createElement("style");t.textContent=`
      .au-switch {
        display: inline-flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    `,this.tabsList=document.createElement("ul"),this.tabsList.setAttribute("role","tablist"),this.tabsList.classList.add("au-tablist");const t=document.createElement("slot");t.name="panel",this.container.append(e,this.tabsList,t),this.shadowRoot.appendChild(this.container)}connectedCallback(){this.shadowRoot.querySelector('slot[name="panel"]').addEventListener("slotchange",()=>{this._renderTabs(),this._attachEvents()}),this._renderTabs(),this._attachEvents()}_renderTabs(){const t=this.shadowRoot.querySelector('slot[name="panel"]').assignedElements().filter(a=>a.classList.contains("au-tab-panel"));this._tabs=[],this._panels=[],this.tabsList.innerHTML="",t.forEach((a,i)=>{const r=a.getAttribute("label")||`Tab ${i+1}`,s=a.getAttribute("data-prefix")||"",o=a.getAttribute("data-badge")||"",n=a.getAttribute("data-affix")||"",b=a.id||this.generateId(),c=`tab-${b}`,h=`panel-${b}`;a.setAttribute("id",h),a.setAttribute("role","tabpanel"),a.setAttribute("aria-labelledby",c),a.setAttribute("aria-hidden",i===0?"false":"true");const l=document.createElement("li");l.setAttribute("role","presentation"),l.className="au-tablist-item"+(i===0?" au-tablist-item--selected":"");const d=document.createElement("button");d.setAttribute("role","tab"),d.setAttribute("id",c),d.setAttribute("aria-controls",h),d.setAttribute("aria-selected",i===0?"true":"false"),d.setAttribute("tabindex",i===0?"0":"-1");const u=document.createDocumentFragment();if(s){const p=document.createElement("span");p.className="prefix",p.textContent=s,u.appendChild(p)}const v=document.createElement("span");if(v.className="label",v.textContent=r,u.appendChild(v),o){const p=document.createElement("span");p.className="badge",p.setAttribute("aria-label",`補充資訊：${o}`),p.textContent=o,u.appendChild(p)}if(n){const p=document.createElement("span");p.className="affix",p.textContent=n,u.appendChild(p)}d.appendChild(u),l.appendChild(d),this.tabsList.appendChild(l),this._tabs.push(d),this._panels.push(a)})}_attachEvents(){this._tabs.forEach((e,t)=>{e.addEventListener("click",()=>this._selectTab(t)),e.addEventListener("keydown",a=>this._onKeydown(a,t))})}_selectTab(e){var t;this._tabs.forEach((a,i)=>{const r=i===e;a.setAttribute("aria-selected",r),a.setAttribute("tabindex",r?"0":"-1"),a.parentElement.classList.toggle("au-tablist-item--selected",r),this._panels[i].setAttribute("aria-hidden",!r)}),this._tabs[e].focus(),this._selectedIndex=e,this.dispatchEvent(new CustomEvent("tab-change",{bubbles:!0,composed:!0,detail:{index:e,label:((t=this._panels[e])==null?void 0:t.getAttribute("label"))??""}}))}_onKeydown(e,t){const a=this._tabs.length-1;let i=t;switch(e.key){case"ArrowRight":case"ArrowDown":i=t===a?0:t+1;break;case"ArrowLeft":case"ArrowUp":i=t===0?a:t-1;break;case"Home":i=0;break;case"End":i=a;break;default:return}e.preventDefault(),this._selectTab(i)}get selectedIndex(){return this._selectedIndex}set selectedIndex(e){this._selectTab(e)}generateId(){if(typeof crypto<"u"&&crypto.getRandomValues){const e=new Uint32Array(1);return crypto.getRandomValues(e),e[0].toString(36)}return Math.random().toString(36).slice(2)}}typeof customElements<"u"&&!customElements.get("au-tabs")&&customElements.define("au-tabs",F);class L extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals(),this._id=this.getAttribute("id")||this.generateId(),this._initialValue="",this._initialValueSet=!1;const e=document.createElement("style");e.textContent=`
      .textarea-wrapper {
        display: flex;
        flex-direction: column;
        gap: 0.25rem;
