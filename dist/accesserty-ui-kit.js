var S=Object.defineProperty;var R=(g,e,t)=>e in g?S(g,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):g[e]=t;var w=(g,e,t)=>R(g,typeof e!="symbol"?e+"":e,t);class z extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const e=document.createElement("div");e.setAttribute("class","au-accordion");const t=document.createElement("slot");e.appendChild(t),this.shadowRoot.appendChild(e)}}customElements.define("au-accordion",z);class I extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const e=this.generateId(),t=this.generateId(),a=document.createElement("div");a.setAttribute("class","au-accordion-item"),a.innerHTML=`
      ...
      >
        <ol>
          ${n.map((h,b)=>`
                <li>
                  ${b===n.length-1?`<span aria-current="page"><slot name="icon-${b+1}"></slot><span>${h.text}</span></span>`:`<a href="${h.url||""}" title="${s} ${h.text}"><slot name="icon-${b+1}"></slot><span>${h.text}</span></a>`}
                  ${b!==n.length-1?'<span aria-hidden="true">'+o+"</span>":""}
                </li>
              `).join("")}
        </ol>
      </nav>
    `}}customElements.define("au-breadcrumbs",N);class $ extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    ...
    `}}customElements.define("au-card",$);class A extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals();const e=this.generateId(),t=document.createElement("style");t.textContent=`
      .au-checkbox {
        display: inline-block;
    ...
    `,this.shadowRoot.appendChild(e.content.cloneNode(!0)),this.item=this.shadowRoot.querySelector(".item")}connectedCallback(){this.setAttribute("tabindex","-1"),this.setAttribute("role","none"),this.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("selected",{bubbles:!0,composed:!0,detail:{value:this.getAttribute("value")}}));const e=this.closest("au-dropdown");e&&e.close()}),this.item.addEventListener("keydown",e=>{if(e.key==="Enter"||e.key===" "){e.preventDefault();const t=this.querySelector("a");t?t.click():this.click()}})}focus(){this.item.focus()}}customElements.define("au-dropdown",T);customElements.define("au-dropdown-item",D);class C extends HTMLElement{constructor(){super();w(this,"_preventDefault",t=>t.preventDefault());this.attachShadow({mode:"open"}),this.internals=this.attachInternals(),this.files=[],this.previewUrls=new Map;const t=document.createElement("style");t.textContent=`
  ...
  `;const t=document.createElement("div");t.className="input-wrapper",this.wrapper=t,this.labelEl=document.createElement("label"),this.labelEl.setAttribute("for",this._id),this.labelEl.textContent=this.getAttribute("label")||"";const a=document.createElement("div");a.className="input-container",this.prefixSlot=document.createElement("slot"),this.prefixSlot.name="prefix",this.prefixSpan=document.createElement("span"),this.prefixSpan.className="prefix",this.prefixSpan.appendChild(this.prefixSlot),this.prefixSpan.hidden=!0,this.input=document.createElement("input"),this.input.id=this._id,this.syncAttributes(),this.clearButton=document.createElement("button"),this.clearButton.type="button",this.clearButton.className="clear-input",this.clearButton.textContent="✖",this.clearButton.hidden=!0,this.clearButton.setAttribute("part","clear"),this.clearButton.addEventListener("click",()=>{this.clear()}),this.affixSlot=document.createElement("slot"),this.affixSlot.name="affix",this.affixSpan=document.createElement("span"),this.affixSpan.className="affix",this.affixSpan.appendChild(this.affixSlot),this.affixSpan.hidden=!0,a.append(this.prefixSpan,this.input,this.clearButton,this.affixSpan),t.append(this.labelEl,a),this.shadowRoot.append(e,t),this.input.addEventListener("input",()=>{this.value=this.input.value,this.dispatchEvent(new Event("input",{bubbles:!0})),this.internals.setFormValue(this.value),this._syncValidity(),this._updateClearButton()}),this.input.addEventListener("change",()=>{this.dispatchEvent(new Event("change",{bubbles:!0}))}),this.prefixSlot.addEventListener("slotchange",()=>{this.prefixSpan.hidden=this.prefixSlot.assignedNodes().length===0}),this.affixSlot.addEventListener("slotchange",()=>{this.affixSpan.hidden=this.affixSlot.assignedNodes().length===0})}static get observedAttributes(){return["type","name","value","placeholder","required","disabled","readonly","label","min","max","step","pattern","autocomplete","autofocus","inputmode","maxlength","minlength","data-size","data-layout","data-clear","data-clear-label"]}attributeChangedCallback(e,t,a){e==="label"&&this.labelEl?this.labelEl.textContent=a:(e==="data-size"||e==="data-layout")&&this.wrapper?a===null?this.wrapper.removeAttribute(e):this.wrapper.setAttribute(e,a):e==="data-clear"||e==="data-clear-label"?this._updateClearButton():this.input&&(a===null&&typeof this.input[e]=="boolean"?(this.input[e]=!1,this.input.removeAttribute(e)):(this.input.setAttribute(e,a),typeof this.input[e]=="boolean"&&(this.input[e]=!0)),this._syncValidity())}get validity(){return this.internals.validity}get validationMessage(){return this.internals.validationMessage}get willValidate(){return this.internals.willValidate}checkValidity(){return this.internals.checkValidity()}reportValidity(){return this.internals.reportValidity()}connectedCallback(){this._initialValueSet||(this._initialValue=this.input.value,this._initialValueSet=!0),this.internals.setFormValue(this.input.value),this._syncValidity(),this._updateClearButton()}formResetCallback(){this.input.value=this._initialValue||"",this.internals.setFormValue(this.input.value),this._syncValidity(),this._updateClearButton()}get value(){var e;return(e=this.input)==null?void 0:e.value}set value(e){this.input&&(this.input.value=e,this.setAttribute("value",e),this.internals.setFormValue(e),this._syncValidity(),this._updateClearButton())}clear(){this.input.value="",this.value="",this.internals.setFormValue(""),this.dispatchEvent(new Event("input",{bubbles:!0})),this.dispatchEvent(new Event("change",{bubbles:!0})),this._updateClearButton()}suggest(e=""){this.input.value=e,this.value=e,this.internals.setFormValue(e),this.dispatchEvent(new Event("input",{bubbles:!0})),this._updateClearButton()}focus(){var e;(e=this.input)==null||e.focus()}generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),`au-input-${e[0].toString(36)}`}syncAttributes(){Array.from(this.attributes).forEach(e=>{["data-size","data-layout","data-clear","data-clear-label"].includes(e.name)||(this.input.setAttribute(e.name,e.value),e.name==="value"&&(this.input.defaultValue=e.value))})}_syncValidity(){this.input&&(this.input.validity.valid?this.internals.setValidity({}):this.internals.setValidity(this.input.validity,this.input.validationMessage,this.input))}_updateClearButton(){const e=this.hasAttribute("data-clear"),t=this.input.value.length>0,a=this.getAttribute("data-clear-label")||"Clear input";this.clearButton.setAttribute("aria-label",a),this.clearButton.hidden=!(e&&t)}}w(_,"formAssociated",!0);customElements.define("au-input",_);class E extends HTMLElement{static get observedAttributes(){return["data-total","data-current-page","data-pager-count","data-page-size","data-page-size-options","data-layout","data-text-total-pages-prefix","data-text-page","data-text-total-items-suffix","data-text-per","data-text-first","data-text-prev","data-text-next","data-text-last","data-text-go","data-text-goto"]}static generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),`au-pagination-${e[0].toString(36)}`}constructor(){super(),this.attachShadow({mode:"open"}),this._selectId=E.generateId(),this._jumpId=E.generateId(),this.liveRegion=document.createElement("div"),this.liveRegion.setAttribute("aria-live","polite"),this.liveRegion.setAttribute("role","status"),this.liveRegion.setAttribute("aria-atomic","true"),this._parseAttributes(),this._render()}attributeChangedCallback(){this._parseAttributes(),this._requestRender()}_requestRender(){this._updatePending||(this._updatePending=!0,requestAnimationFrame(()=>{this._render(),this._updatePending=!1}))}_parseAttributes(){this.total=parseInt(this.getAttribute("data-total"))||0,this.currentPage=parseInt(this.getAttribute("data-current-page"))||1,this.pagerCount=parseInt(this.getAttribute("data-pager-count"))||5,this.pageSize=parseInt(this.getAttribute("data-page-size"))||10;const e=this.getAttribute("data-page-size-options");if(e)try{this.pageSizeOptions=JSON.parse(e)}catch{this.pageSizeOptions=e.split(",").map(a=>parseInt(a.trim()))}else this.pageSizeOptions=[10,30,50,100];const t=this.getAttribute("data-layout");if(t)try{this.layout=JSON.parse(t)}catch{this.layout=t.replace(/[[\]' ]/g,"").split(",")}else this.layout=["total_page","total_items","page_size","first","prev","pages","next","last","jump"];this.texts={totalPagesPrefix:this.getAttribute("data-text-total-pages-prefix")||"Total",pageSuffix:this.getAttribute("data-text-page")||"page(s)",totalItemsSuffix:this.getAttribute("data-text-total-items-suffix")||"item(s)",perText:this.getAttribute("data-text-per")||"each page",firstText:this.getAttribute("data-text-first")||"First",prevText:this.getAttribute("data-text-prev")||"Prev",nextText:this.getAttribute("data-text-next")||"Next",lastText:this.getAttribute("data-text-last")||"Last",goText:this.getAttribute("data-text-go")||"go to",gotoText:this.getAttribute("data-text-goto")||"go to"}}get totalPages(){return Math.ceil(this.total/this.pageSize)||1}get pagers(){const t=Math.floor((this.currentPage-1)/this.pagerCount)*this.pagerCount+1,a=Math.min(t+this.pagerCount-1,this.totalPages),i=[];for(let r=t;r<=a;r++)i.push(r);return i}_render(){const e=this.texts,t=this.layout,a=this.totalPages,i=this.total;this.shadowRoot.innerHTML="";const r=document.createElement("style");r.textContent=`
    ...
    `,this.shadowRoot.appendChild(r);const n=document.createElement("div");n.className="au-pagination";const o=document.createElement("div");o.className="au-pagination-container";const s=document.createElement("div");if(s.className="au-pagination-group",t.includes("total_page")){const d=document.createElement("span");d.textContent=`${e.totalPagesPrefix}${a}${e.pageSuffix}`,s.appendChild(d)}if(t.includes("total_items")){const d=document.createElement("span");d.textContent=`${i}${e.totalItemsSuffix}`,s.appendChild(d)}if(t.includes("page_size")){const d=document.createElement("span");d.className="visually-hidden",d.textContent="Page size",s.appendChild(d);const l=document.createElement("label");l.setAttribute("for",this._selectId),l.textContent=e.perText,s.appendChild(l);const c=document.createElement("select");c.id=this._selectId,this.pageSizeOptions.forEach(p=>{const f=document.createElement("option");f.value=p,f.textContent=p,p===this.pageSize&&(f.selected=!0),c.appendChild(f)}),c.addEventListener("change",p=>{this.pageSize=+p.target.value,this.setAttribute("data-page-size",this.pageSize),this.dispatchEvent(new CustomEvent("page-size-change",{detail:this.pageSize,bubbles:!0,composed:!0})),this.currentPage=1,this.setAttribute("data-current-page","1")}),s.appendChild(c);const v=document.createElement("span");v.textContent=e.totalItemsSuffix,s.appendChild(v)}o.appendChild(s);const u=document.createElement("div");u.className="au-pagination-group";const h=document.createElement("ul");if(h.className="pagination-buttons",t.includes("first")){const d=document.createElement("li"),l=document.createElement("button");l.textContent=e.firstText,l.disabled=this.currentPage===1,l.addEventListener("click",()=>this._goto(1)),d.appendChild(l),h.appendChild(d)}if(t.includes("prev")){const d=document.createElement("li"),l=document.createElement("button");l.textContent=e.prevText,l.disabled=this.currentPage===1,l.addEventListener("click",()=>this._goto(this.currentPage-1)),d.appendChild(l),h.appendChild(d)}if(t.includes("pages")&&this.pagers.forEach(d=>{const l=document.createElement("li"),c=document.createElement("button");c.className="pager",d===this.currentPage?(c.setAttribute("aria-current","page"),c.setAttribute("part","current-page")):(c.removeAttribute("aria-current"),c.removeAttribute("part")),c.textContent=d,c.addEventListener("click",()=>this._goto(d)),l.appendChild(c),h.appendChild(l)}),t.includes("next")){const d=document.createElement("li"),l=document.createElement("button");l.textContent=e.nextText,l.disabled=this.currentPage>=a,l.addEventListener("click",()=>this._goto(this.currentPage+1)),d.appendChild(l),h.appendChild(d)}if(t.includes("last")){const d=document.createElement("li"),l=document.createElement("button");l.textContent=e.lastText,l.disabled=this.currentPage>=a,l.addEventListener("click",()=>this._goto(a)),d.appendChild(l),h.appendChild(d)}const b=document.createElement("nav");if(b.setAttribute("aria-label","pagination"),b.appendChild(h),u.appendChild(b),o.appendChild(u),t.includes("jump")){const d=document.createElement("div");d.className="au-pagination-group";const l=document.createElement("label");l.setAttribute("for",this._jumpId),l.textContent=e.goText,d.appendChild(l);const c=document.createElement("input");c.type="number",c.id=this._jumpId,c.min="1",c.max=String(a),c.value=String(this.currentPage),c.addEventListener("keyup",f=>{f.key==="Enter"&&this._goto(+c.value)}),d.appendChild(c);const v=document.createElement("span");v.textContent=e.pageSuffix,d.appendChild(v);const p=document.createElement("button");p.type="button",p.textContent=e.gotoText,p.addEventListener("click",()=>this._goto(+c.value)),d.appendChild(p),o.appendChild(d)}n.appendChild(o),this.shadowRoot.append(n,this.liveRegion)}_goto(e){e<1&&(e=1),e>this.totalPages&&(e=this.totalPages),e!==this.currentPage&&(this.currentPage=e,this.setAttribute("data-current-page",String(e)),this.dispatchEvent(new CustomEvent("page-change",{detail:e,bubbles:!0,composed:!0})),this.announce(`Page ${e}`))}announce(e){for(;this.liveRegion.firstChild;)this.liveRegion.removeChild(this.liveRegion.firstChild);requestAnimationFrame(()=>{const t=document.createElement("span");t.textContent=e,this.liveRegion.appendChild(t)})}}customElements.define("au-pagination",E);class M extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const e=document.createElement("style");e.textContent=`
      .au-radio-group {
        display: flex;
        flex-wrap: wrap;
        gap: 1rem;
    ...
    `,this.tabsList=document.createElement("ul"),this.tabsList.setAttribute("role","tablist"),this.tabsList.classList.add("au-tablist");const t=document.createElement("slot");t.name="panel",this.container.append(e,this.tabsList,t),this.shadowRoot.appendChild(this.container)}connectedCallback(){this.shadowRoot.querySelector('slot[name="panel"]').addEventListener("slotchange",()=>{this._renderTabs(),this._attachEvents()}),this._renderTabs(),this._attachEvents()}_renderTabs(){const t=this.shadowRoot.querySelector('slot[name="panel"]').assignedElements().filter(a=>a.classList.contains("au-tab-panel"));this._tabs=[],this._panels=[],this.tabsList.innerHTML="",t.forEach((a,i)=>{const r=a.getAttribute("label")||`Tab ${i+1}`,n=a.getAttribute("data-prefix")||"",o=a.getAttribute("data-badge")||"",s=a.getAttribute("data-affix")||"",u=a.id||this.generateId(),h=`tab-${u}`,b=`panel-${u}`;a.setAttribute("id",b),a.setAttribute("role","tabpanel"),a.setAttribute("aria-labelledby",h),a.setAttribute("aria-hidden",i===0?"false":"true");const d=document.createElement("li");d.setAttribute("role","presentation"),d.className="au-tablist-item"+(i===0?" au-tablist-item--selected":"");const l=document.createElement("button");l.setAttribute("role","tab"),l.setAttribute("id",h),l.setAttribute("aria-controls",b),l.setAttribute("aria-selected",i===0?"true":"false"),l.setAttribute("tabindex",i===0?"0":"-1");const c=document.createDocumentFragment();if(n){const p=document.createElement("span");p.className="prefix",p.textContent=n,c.appendChild(p)}const v=document.createElement("span");if(v.className="label",v.textContent=r,c.appendChild(v),o){const p=document.createElement("span");p.className="badge",p.setAttribute("aria-label",`補充資訊：${o}`),p.textContent=o,c.appendChild(p)}if(s){const p=document.createElement("span");p.className="affix",p.textContent=s,c.appendChild(p)}l.appendChild(c),d.appendChild(l),this.tabsList.appendChild(d),this._tabs.push(l),this._panels.push(a)})}_attachEvents(){this._tabs.forEach((e,t)=>{e.addEventListener("click",()=>this._selectTab(t)),e.addEventListener("keydown",a=>this._onKeydown(a,t))})}_selectTab(e){this._tabs.forEach((t,a)=>{const i=a===e;t.setAttribute("aria-selected",i),t.setAttribute("tabindex",i?"0":"-1"),t.parentElement.classList.toggle("au-tablist-item--selected",i),this._panels[a].setAttribute("aria-hidden",!i)}),this._tabs[e].focus(),this._selectedIndex=e}_onKeydown(e,t){const a=this._tabs.length-1;let i=t;switch(e.key){case"ArrowRight":case"ArrowDown":i=t===a?0:t+1;break;case"ArrowLeft":case"ArrowUp":i=t===0?a:t-1;break;case"Home":i=0;break;case"End":i=a;break;default:return}e.preventDefault(),this._selectTab(i)}generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0].toString(36)}}customElements.define("au-tabs",F);class L extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals(),this._id=this.getAttribute("id")||this.generateId();const e=document.createElement("style");e.textContent=`
      .textarea-wrapper {
        display: flex;
        flex-direction: column;
        gap: 0.25rem;
    ...
    `,this.renderContent(),this.hasChildren){const a=this.shadowRoot.querySelector('div[role="group"]');e.forEach(i=>{const r=document.createElement("au-tree-node");r.data=i,r.toggleLabel=this._toggleLabel,t&&r.setAttribute("show-checkbox",""),a.appendChild(r)})}this.setAttribute("role","treeitem"),this.hasChildren&&this.setAttribute("aria-expanded","false"),t&&this.setAttribute("aria-checked","false")}renderContent(){const e=this.shadowRoot.querySelector(".node-content");if(!e)return;const t=this.hasAttribute("show-checkbox"),a=`<svg class="toggle-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" aria-hidden="true"/></svg><span class="visually-hidden">${this._data.label||"Node"}</span>`,i=typeof this._toggleLabel=="function"?this._toggleLabel(this._data):`Toggle ${this._data.label||"Node"}`,r=this.hasChildren?`<button class="toggle-btn" tabindex="-1" aria-label="${i}">${a}</button>`:`<button class="toggle-btn hidden" tabindex="-1" aria-hidden="true">${a}</button>`,n=t?`<div class="au-checkbox"><input type="checkbox" id="${this._uid}" tabindex="-1" ${this.checked?"checked":""}>`:"",o=`${this._uid}-label`,s=t?`<label id="${o}" for="${this._uid}">${this._data.label||""}</label></div>`:`<span>${this._data.label||""}</span>`;if(e.innerHTML=`
        ${r}
        ${n}
        ${s}
      `,this.setAttribute("aria-labelledby",o),t&&this.indeterminate){const h=e.querySelector("input");h&&(h.indeterminate=!0)}const u=e.querySelector(".toggle-icon");this.expanded&&u&&(u.style.transform="rotate(90deg)")}}customElements.define("au-tree",P);customElements.define("au-tree-node",k);
