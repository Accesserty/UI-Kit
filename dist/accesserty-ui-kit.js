var S=Object.defineProperty;var z=(b,e,t)=>e in b?S(b,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):b[e]=t;var w=(b,e,t)=>z(b,typeof e!="symbol"?e+"":e,t);class I extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const e=document.createElement("div");e.setAttribute("class","au-accordion");const t=document.createElement("slot");e.appendChild(t),this.shadowRoot.appendChild(e)}}customElements.define("au-accordion",I);class _ extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const e=this.generateId(),t=this.generateId(),a=document.createElement("div");a.setAttribute("class","au-accordion-item"),a.innerHTML=`
        <style>
          .au-accordion-item {
      ...
      `,this.shadowRoot.append(a),this.button=this.shadowRoot.querySelector("button"),this.button.addEventListener("click",()=>this.toggleAccordion())}connectedCallback(){this.updateExpanded()}static get observedAttributes(){return["open"]}attributeChangedCallback(e,t,a){e==="open"&&this.updateExpanded()}updateExpanded(){const e=this.hasAttribute("open");this.button.setAttribute("aria-expanded",e);const t=this.shadowRoot.querySelector('div[role="region"]');e?t.removeAttribute("hidden"):t.setAttribute("hidden","")}generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),`au-accordion-item-${e[0].toString(36)}`}toggleAccordion(){this.hasAttribute("open")?this.removeAttribute("open"):this.setAttribute("open","")}}customElements.define("au-accordion-item",_);class R extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.attachInitialAttributes(),this.render()}attachInitialAttributes(){Array.from(this.attributes).forEach(e=>{e.name!=="style"&&!["class","label","items","separator"].includes(e.name)&&this.shadowRoot.host.setAttribute(e.name,e.value)})}static get observedAttributes(){return["id","class","aria-label","aria-labelledby","label","items","separator"]}attributeChangedCallback(e,t,a){t!==a&&this.render()}get items(){try{return JSON.parse(this.getAttribute("items")||"[]")}catch(e){return console.error("Error parsing 'items':",e),[]}}set items(e){try{JSON.parse(e),this.setAttribute("items",e),this.render()}catch{console.error("Invalid JSON provided for 'items':",e)}}render(){const e=this.getAttribute("id"),t=this.getAttribute("class"),a=this.getAttribute("aria-label"),i=this.getAttribute("aria-labelledby"),o=this.getAttribute("label"),l=this.items,r=this.getAttribute("separator")||"/",c=this.getAttribute("data-link-title-prefix")||"go to";let u="";a!==null?u=`aria-label="${a}"`:i!==null?u=`aria-labelledby="${i}"`:o!==null&&(u=`aria-label="${o}"`),this.shadowRoot.innerHTML=`
      <style>
        nav {
      ...
      >
        <ol>
          ${l.map((p,m)=>`
                <li>
                  ${m===l.length-1?`<span aria-current="page"><slot name="icon-${m+1}"></slot><span>${p.text}</span></span>`:`<a href="${p.url||""}" title="${c} ${p.text}"><slot name="icon-${m+1}"></slot><span>${p.text}</span></a>`}
                  ${m!==l.length-1?'<span aria-hidden="true">'+r+"</span>":""}
                </li>
              `).join("")}
        </ol>
      </nav>
    ...
    `,this.shadowRoot.appendChild(e.content.cloneNode(!0)),this.item=this.shadowRoot.querySelector(".item")}connectedCallback(){this.setAttribute("tabindex","-1"),this.setAttribute("role","none"),this.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("selected",{bubbles:!0,composed:!0,detail:{value:this.getAttribute("value")}}));const e=this.closest("au-dropdown");e&&e.close()}),this.item.addEventListener("keydown",e=>{if(e.key==="Enter"||e.key===" "){e.preventDefault();const t=this.querySelector("a");t?t.click():this.click()}})}focus(){this.item.focus()}}customElements.define("au-dropdown",V);customElements.define("au-dropdown-item",$);class A extends HTMLElement{constructor(){super();w(this,"_preventDefault",t=>t.preventDefault());this.attachShadow({mode:"open"}),this.internals=this.attachInternals(),this.files=[],this.previewUrls=new Map;const t=document.createElement("style");t.textContent=`
  ...
  `;const t=document.createElement("div");t.className="input-wrapper",this.wrapper=t,this.labelEl=document.createElement("label"),this.labelEl.setAttribute("for",this._id),this.labelEl.textContent=this.getAttribute("label")||"";const a=document.createElement("div");a.className="input-container",this.prefixSlot=document.createElement("slot"),this.prefixSlot.name="prefix",this.prefixSpan=document.createElement("span"),this.prefixSpan.className="prefix",this.prefixSpan.appendChild(this.prefixSlot),this.prefixSpan.hidden=!0,this.input=document.createElement("input"),this.input.id=this._id,this.syncAttributes(),this.clearButton=document.createElement("button"),this.clearButton.type="button",this.clearButton.className="clear-input",this.clearButton.textContent="✖",this.clearButton.hidden=!0,this.clearButton.setAttribute("part","clear"),this.clearButton.addEventListener("click",()=>{this.clear()}),this.affixSlot=document.createElement("slot"),this.affixSlot.name="affix",this.affixSpan=document.createElement("span"),this.affixSpan.className="affix",this.affixSpan.appendChild(this.affixSlot),this.affixSpan.hidden=!0,a.append(this.prefixSpan,this.input,this.clearButton,this.affixSpan),t.append(this.labelEl,a),this.shadowRoot.append(e,t),this.input.addEventListener("input",()=>{this.value=this.input.value,this.dispatchEvent(new Event("input",{bubbles:!0})),this.internals.setFormValue(this.value),this._syncValidity(),this._updateClearButton()}),this.input.addEventListener("change",()=>{this.dispatchEvent(new Event("change",{bubbles:!0}))}),this.prefixSlot.addEventListener("slotchange",()=>{this.prefixSpan.hidden=this.prefixSlot.assignedNodes().length===0}),this.affixSlot.addEventListener("slotchange",()=>{this.affixSpan.hidden=this.affixSlot.assignedNodes().length===0})}static get observedAttributes(){return["type","name","value","placeholder","required","disabled","readonly","label","min","max","step","pattern","autocomplete","autofocus","inputmode","maxlength","minlength","data-size","data-layout","data-clear","data-clear-label"]}attributeChangedCallback(e,t,a){e==="label"&&this.labelEl?this.labelEl.textContent=a:(e==="data-size"||e==="data-layout")&&this.wrapper?a===null?this.wrapper.removeAttribute(e):this.wrapper.setAttribute(e,a):e==="data-clear"||e==="data-clear-label"?this._updateClearButton():this.input&&(a===null&&typeof this.input[e]=="boolean"?(this.input[e]=!1,this.input.removeAttribute(e)):(this.input.setAttribute(e,a),typeof this.input[e]=="boolean"&&(this.input[e]=!0)),this._syncValidity())}get validity(){return this.internals.validity}get validationMessage(){return this.internals.validationMessage}get willValidate(){return this.internals.willValidate}checkValidity(){return this.internals.checkValidity()}reportValidity(){return this.internals.reportValidity()}connectedCallback(){this._initialValueSet||(this._initialValue=this.input.value,this._initialValueSet=!0),this.internals.setFormValue(this.input.value),this._syncValidity(),this._updateClearButton()}formResetCallback(){this.input.value=this._initialValue||"",this.internals.setFormValue(this.input.value),this._syncValidity(),this._updateClearButton()}get value(){var e;return(e=this.input)==null?void 0:e.value}set value(e){this.input&&(this.input.value=e,this.setAttribute("value",e),this.internals.setFormValue(e),this._syncValidity(),this._updateClearButton())}clear(){this.input.value="",this.value="",this.internals.setFormValue(""),this.dispatchEvent(new Event("input",{bubbles:!0})),this.dispatchEvent(new Event("change",{bubbles:!0})),this._updateClearButton()}suggest(e=""){this.input.value=e,this.value=e,this.internals.setFormValue(e),this.dispatchEvent(new Event("input",{bubbles:!0})),this._updateClearButton()}focus(){var e;(e=this.input)==null||e.focus()}generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),`au-input-${e[0].toString(36)}`}syncAttributes(){Array.from(this.attributes).forEach(e=>{["data-size","data-layout","data-clear","data-clear-label"].includes(e.name)||(this.input.setAttribute(e.name,e.value),e.name==="value"&&(this.input.defaultValue=e.value))})}_syncValidity(){this.input&&(this.input.validity.valid?this.internals.setValidity({}):this.internals.setValidity(this.input.validity,this.input.validationMessage,this.input))}_updateClearButton(){const e=this.hasAttribute("data-clear"),t=this.input.value.length>0,a=this.getAttribute("data-clear-label")||"Clear input";this.clearButton.setAttribute("aria-label",a),this.clearButton.hidden=!(e&&t)}}w(C,"formAssociated",!0);customElements.define("au-input",C);class y extends HTMLElement{static get observedAttributes(){return["data-total","data-current-page","data-pager-count","data-page-size","data-page-size-options","data-layout","data-text-total-pages-prefix","data-text-page","data-text-total-items-suffix","data-text-per","data-text-first","data-text-prev","data-text-next","data-text-last","data-text-go","data-text-goto"]}static generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),`au-pagination-${e[0].toString(36)}`}constructor(){super(),this.attachShadow({mode:"open"}),this._selectId=y.generateId(),this._jumpId=y.generateId(),this.liveRegion=document.createElement("div"),this.liveRegion.setAttribute("aria-live","polite"),this.liveRegion.setAttribute("role","status"),this.liveRegion.setAttribute("aria-atomic","true"),this._parseAttributes(),this._render()}attributeChangedCallback(){this._parseAttributes(),this._requestRender()}_requestRender(){this._updatePending||(this._updatePending=!0,requestAnimationFrame(()=>{this._render(),this._updatePending=!1}))}_parseAttributes(){this.total=parseInt(this.getAttribute("data-total"))||0,this.currentPage=parseInt(this.getAttribute("data-current-page"))||1,this.pagerCount=parseInt(this.getAttribute("data-pager-count"))||5,this.pageSize=parseInt(this.getAttribute("data-page-size"))||10;const e=this.getAttribute("data-page-size-options");if(e)try{this.pageSizeOptions=JSON.parse(e)}catch{this.pageSizeOptions=e.split(",").map(a=>parseInt(a.trim()))}else this.pageSizeOptions=[10,30,50,100];const t=this.getAttribute("data-layout");if(t)try{this.layout=JSON.parse(t)}catch{this.layout=t.replace(/[[\]' ]/g,"").split(",")}else this.layout=["total_page","total_items","page_size","first","prev","pages","next","last","jump"];this.texts={totalPagesPrefix:this.getAttribute("data-text-total-pages-prefix")||"Total",pageSuffix:this.getAttribute("data-text-page")||"page(s)",totalItemsSuffix:this.getAttribute("data-text-total-items-suffix")||"item(s)",perText:this.getAttribute("data-text-per")||"each page",firstText:this.getAttribute("data-text-first")||"First",prevText:this.getAttribute("data-text-prev")||"Prev",nextText:this.getAttribute("data-text-next")||"Next",lastText:this.getAttribute("data-text-last")||"Last",goText:this.getAttribute("data-text-go")||"go to",gotoText:this.getAttribute("data-text-goto")||"go to"}}get totalPages(){return Math.ceil(this.total/this.pageSize)||1}get pagers(){const t=Math.floor((this.currentPage-1)/this.pagerCount)*this.pagerCount+1,a=Math.min(t+this.pagerCount-1,this.totalPages),i=[];for(let o=t;o<=a;o++)i.push(o);return i}_render(){const e=this.texts,t=this.layout,a=this.totalPages,i=this.total;this.shadowRoot.innerHTML="";const o=document.createElement("style");o.textContent=`
    ...
    `,this.shadowRoot.appendChild(o);const l=document.createElement("div");l.className="au-pagination";const r=document.createElement("div");r.className="au-pagination-container";const c=document.createElement("div");if(c.className="au-pagination-group",t.includes("total_page")){const s=document.createElement("span");s.textContent=`${e.totalPagesPrefix}${a}${e.pageSuffix}`,c.appendChild(s)}if(t.includes("total_items")){const s=document.createElement("span");s.textContent=`${i}${e.totalItemsSuffix}`,c.appendChild(s)}if(t.includes("page_size")){const s=document.createElement("span");s.className="visually-hidden",s.textContent="Page size",c.appendChild(s);const n=document.createElement("label");n.setAttribute("for",this._selectId),n.textContent=e.perText,c.appendChild(n);const d=document.createElement("select");d.id=this._selectId,this.pageSizeOptions.forEach(h=>{const v=document.createElement("option");v.value=h,v.textContent=h,h===this.pageSize&&(v.selected=!0),d.appendChild(v)}),d.addEventListener("change",h=>{this.pageSize=+h.target.value,this.setAttribute("data-page-size",this.pageSize),this.dispatchEvent(new CustomEvent("page-size-change",{detail:this.pageSize,bubbles:!0,composed:!0})),this.currentPage=1,this.setAttribute("data-current-page","1")}),c.appendChild(d);const f=document.createElement("span");f.textContent=e.totalItemsSuffix,c.appendChild(f)}r.appendChild(c);const u=document.createElement("div");u.className="au-pagination-group";const p=document.createElement("ul");if(p.className="pagination-buttons",t.includes("first")){const s=document.createElement("li"),n=document.createElement("button");n.textContent=e.firstText,n.disabled=this.currentPage===1,n.addEventListener("click",()=>this._goto(1)),s.appendChild(n),p.appendChild(s)}if(t.includes("prev")){const s=document.createElement("li"),n=document.createElement("button");n.textContent=e.prevText,n.disabled=this.currentPage===1,n.addEventListener("click",()=>this._goto(this.currentPage-1)),s.appendChild(n),p.appendChild(s)}if(t.includes("pages")&&this.pagers.forEach(s=>{const n=document.createElement("li"),d=document.createElement("button");d.className="pager",s===this.currentPage?(d.setAttribute("aria-current","page"),d.setAttribute("part","current-page")):(d.removeAttribute("aria-current"),d.removeAttribute("part")),d.textContent=s,d.addEventListener("click",()=>this._goto(s)),n.appendChild(d),p.appendChild(n)}),t.includes("next")){const s=document.createElement("li"),n=document.createElement("button");n.textContent=e.nextText,n.disabled=this.currentPage>=a,n.addEventListener("click",()=>this._goto(this.currentPage+1)),s.appendChild(n),p.appendChild(s)}if(t.includes("last")){const s=document.createElement("li"),n=document.createElement("button");n.textContent=e.lastText,n.disabled=this.currentPage>=a,n.addEventListener("click",()=>this._goto(a)),s.appendChild(n),p.appendChild(s)}const m=document.createElement("nav");if(m.setAttribute("aria-label","pagination"),m.appendChild(p),u.appendChild(m),r.appendChild(u),t.includes("jump")){const s=document.createElement("div");s.className="au-pagination-group";const n=document.createElement("label");n.setAttribute("for",this._jumpId),n.textContent=e.goText,s.appendChild(n);const d=document.createElement("input");d.type="number",d.id=this._jumpId,d.min="1",d.max=String(a),d.value=String(this.currentPage),d.addEventListener("keyup",v=>{v.key==="Enter"&&this._goto(+d.value)}),s.appendChild(d);const f=document.createElement("span");f.textContent=e.pageSuffix,s.appendChild(f);const h=document.createElement("button");h.type="button",h.textContent=e.gotoText,h.addEventListener("click",()=>this._goto(+d.value)),s.appendChild(h),r.appendChild(s)}l.appendChild(r),this.shadowRoot.append(l,this.liveRegion)}_goto(e){e<1&&(e=1),e>this.totalPages&&(e=this.totalPages),e!==this.currentPage&&(this.currentPage=e,this.setAttribute("data-current-page",String(e)),this.dispatchEvent(new CustomEvent("page-change",{detail:e,bubbles:!0,composed:!0})),this.announce(`Page ${e}`))}announce(e){for(;this.liveRegion.firstChild;)this.liveRegion.removeChild(this.liveRegion.firstChild);requestAnimationFrame(()=>{const t=document.createElement("span");t.textContent=e,this.liveRegion.appendChild(t)})}}customElements.define("au-pagination",y);class M extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"});const e=document.createElement("style");e.textContent=`
      .au-radio-group {
        display: flex;
        flex-wrap: wrap;
        gap: 1rem;
    ...
    `;const a=document.createElement("label");a.classList.add("au-switch"),a.setAttribute("for",e);const i=document.createElement("div");i.classList.add("container");const o=document.createElement("span");o.classList.add("off-text"),o.setAttribute("aria-hidden","true");const l=document.createElement("div");l.classList.add("input"),this.inputElement=document.createElement("input"),this.inputElement.id=e,this.inputElement.type="checkbox",this.inputElement.setAttribute("role","switch"),this.inputElement.setAttribute("aria-checked","false"),l.appendChild(this.inputElement);const r=document.createElement("span");r.classList.add("on-text"),r.setAttribute("aria-hidden","true"),i.append(o,l,r),a.append(i),this.shadowRoot.append(t,a);const c=document.createElement("slot");a.prepend(c),this.inputElement.addEventListener("change",u=>{const p=u.target.checked;this.inputElement.setAttribute("aria-checked",p.toString()),this.dispatchEvent(new CustomEvent("change",{detail:p}))})}generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),`au-switch-${e[0].toString(36)}`}static get observedAttributes(){return["name","value","checked","disabled","off","on"]}attributeChangedCallback(e,t,a){const i=this.shadowRoot.querySelector("input"),o=this.shadowRoot.querySelector(".off-text"),l=this.shadowRoot.querySelector(".on-text");if(!(!i||!o||!l))switch(e){case"checked":i.checked=a!==null,i.setAttribute("aria-checked",i.checked.toString());break;case"disabled":i.disabled=a!==null;break;case"off":o.textContent=a||"Off";break;case"on":l.textContent=a||"On";break;default:i.setAttribute(e,a);break}}connectedCallback(){const e=this.shadowRoot.querySelector("input"),t=this.shadowRoot.querySelector(".off-text"),a=this.shadowRoot.querySelector(".on-text");e.setAttribute("aria-checked",e.checked.toString()),this.hasAttribute("off")?t.textContent=this.getAttribute("off"):t.textContent="",this.hasAttribute("on")?a.textContent=this.getAttribute("on"):a.textContent=""}}customElements.define("au-switch",D);class N extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._tabs=[],this._panels=[],this._selectedIndex=0,this.container=document.createElement("div"),this.container.classList.add("au-tabs");const e=document.createElement("style");e.textContent=`
      .au-tablist {
        list-style: none;
        margin: 0;
        padding: 0;
    ...
    `,this.tabsList=document.createElement("ul"),this.tabsList.setAttribute("role","tablist"),this.tabsList.classList.add("au-tablist");const t=document.createElement("slot");t.name="panel",this.container.append(e,this.tabsList,t),this.shadowRoot.appendChild(this.container)}connectedCallback(){this.shadowRoot.querySelector('slot[name="panel"]').addEventListener("slotchange",()=>{this._renderTabs(),this._attachEvents()}),this._renderTabs(),this._attachEvents()}_renderTabs(){const t=this.shadowRoot.querySelector('slot[name="panel"]').assignedElements().filter(a=>a.classList.contains("au-tab-panel"));this._tabs=[],this._panels=[],this.tabsList.innerHTML="",t.forEach((a,i)=>{const o=a.getAttribute("label")||`Tab ${i+1}`,l=a.getAttribute("data-prefix")||"",r=a.getAttribute("data-badge")||"",c=a.getAttribute("data-affix")||"",u=a.id||this.generateId(),p=`tab-${u}`,m=`panel-${u}`;a.setAttribute("id",m),a.setAttribute("role","tabpanel"),a.setAttribute("aria-labelledby",p),a.setAttribute("aria-hidden",i===0?"false":"true");const s=document.createElement("li");s.setAttribute("role","presentation"),s.className="au-tablist-item"+(i===0?" au-tablist-item--selected":"");const n=document.createElement("button");n.setAttribute("role","tab"),n.setAttribute("id",p),n.setAttribute("aria-controls",m),n.setAttribute("aria-selected",i===0?"true":"false"),n.setAttribute("tabindex",i===0?"0":"-1");const d=document.createDocumentFragment();if(l){const h=document.createElement("span");h.className="prefix",h.textContent=l,d.appendChild(h)}const f=document.createElement("span");if(f.className="label",f.textContent=o,d.appendChild(f),r){const h=document.createElement("span");h.className="badge",h.setAttribute("aria-label",`補充資訊：${r}`),h.textContent=r,d.appendChild(h)}if(c){const h=document.createElement("span");h.className="affix",h.textContent=c,d.appendChild(h)}n.appendChild(d),s.appendChild(n),this.tabsList.appendChild(s),this._tabs.push(n),this._panels.push(a)})}_attachEvents(){this._tabs.forEach((e,t)=>{e.addEventListener("click",()=>this._selectTab(t)),e.addEventListener("keydown",a=>this._onKeydown(a,t))})}_selectTab(e){this._tabs.forEach((t,a)=>{const i=a===e;t.setAttribute("aria-selected",i),t.setAttribute("tabindex",i?"0":"-1"),t.parentElement.classList.toggle("au-tablist-item--selected",i),this._panels[a].setAttribute("aria-hidden",!i)}),this._tabs[e].focus(),this._selectedIndex=e}_onKeydown(e,t){const a=this._tabs.length-1;let i=t;switch(e.key){case"ArrowRight":case"ArrowDown":i=t===a?0:t+1;break;case"ArrowLeft":case"ArrowUp":i=t===0?a:t-1;break;case"Home":i=0;break;case"End":i=a;break;default:return}e.preventDefault(),this._selectTab(i)}generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0].toString(36)}}customElements.define("au-tabs",N);class L extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.internals=this.attachInternals(),this._id=this.getAttribute("id")||this.generateId();const e=document.createElement("style");e.textContent=`
      .textarea-wrapper {
        display: flex;
        flex-direction: column;
        gap: 0.25rem;
    ...
    `;const t=document.createElement("div");t.className="textarea-wrapper",this.labelEl=document.createElement("label"),this.labelEl.setAttribute("for",this._id),this.labelEl.textContent=this.getAttribute("label")||"";const a=document.createElement("div");a.className="textarea-container",this.textarea=document.createElement("textarea"),this.textarea.id=this._id;const i=this.getAttribute("label");i&&!this.hasAttribute("aria-label")&&!this.hasAttribute("aria-labelledby")&&this.textarea.setAttribute("aria-label",i),this.textarea.addEventListener("input",()=>{this.value=this.textarea.value,this.dispatchEvent(new Event("input",{bubbles:!0})),this._syncValidity()}),this.textarea.addEventListener("change",()=>{this.dispatchEvent(new Event("change",{bubbles:!0}))}),a.append(this.textarea),t.append(this.labelEl,a),this.shadowRoot.append(e,t)}static get observedAttributes(){return["placeholder","name","rows","cols","disabled","readonly","required","maxlength","minlength","aria-label","aria-labelledby","label","id"]}get validity(){return this.internals.validity}get validationMessage(){return this.internals.validationMessage}get willValidate(){return this.internals.willValidate}checkValidity(){return this.internals.checkValidity()}reportValidity(){return this.internals.reportValidity()}attributeChangedCallback(e,t,a){var i;e==="label"&&this.labelEl?(this.labelEl.textContent=a,!this.hasAttribute("aria-label")&&!this.hasAttribute("aria-labelledby")&&this.textarea.setAttribute("aria-label",a)):e==="id"&&a?(this.textarea.id=a,(i=this.labelEl)==null||i.setAttribute("for",a)):a===null?this.textarea.removeAttribute(e):this.textarea.setAttribute(e,a),this._syncValidity()}connectedCallback(){this.internals.setFormValue(this.textarea.value),this._syncValidity()}get value(){return this.textarea.value}set value(e){this.textarea.value=e,this.internals.setFormValue(e),this._syncValidity()}formResetCallback(){this.value=""}generateId(){const e=new Uint32Array(1);return window.crypto.getRandomValues(e),`au-textarea-${e[0].toString(36)}`}_syncValidity(){this.textarea&&(this.textarea.validity.valid?this.internals.setValidity({}):this.internals.setValidity(this.textarea.validity,this.textarea.validationMessage,this.textarea))}}w(L,"formAssociated",!0);customElements.define("au-textarea",L);
